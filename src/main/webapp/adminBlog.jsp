	...
	<div class="main-content">
		...
		<main>
			...
			<div class="page-content">
                ...
                -->
                <center><h1>Blog Section</h1></center><br>
				...
				<div class="records table-responsive">
					...
					<div class="record-header">
						<div class="add">
							...
							<button><a href="blogInsert.jsp">Add record</a></button>
						</div>
						...
						<table width="100%">
							<thead>
								<tr>
									...
									<th><span class="las la-sort"></span> Editor Name</th>
									<th><span class="las la-sort"></span> Staff ID</th>
							...
							<tbody>
								<tr>
									<td><%=resultSet.getString("idblog")%></td>
									<td><%=resultSet.getString("name")%></td>
									<td><%=resultSet.getString("content")%></td>
									<td><%=resultSet.getString("author")%></td>
									<td><img src="resources/images/blog_new/<%=resultSet.getString("img")%>" width="150px"></td>
									<td><%=resultSet.getString("editorName")%></td>

									<td><%=resultSet.getString("id")%></td>


									<td><c:url value="blogUpdate.jsp" var="cusupdate">
											<c:param name="idblog"
												value='<%=resultSet.getString("idblog")%>' />
											<c:param name="name" value='<%=resultSet.getString("name")%>' />
											<c:param name="content"
												value='<%=resultSet.getString("content")%>' />
											<c:param name="author"
												value='<%=resultSet.getString("author")%>' />
											<c:param name="editorName"
												value='<%=resultSet.getString("editorName")%>' />
											<c:param name="img" value='<%=resultSet.getString("img")%>' />
											<c:param name="StaffID"	value='<%=resultSet.getString("id")%>' />
										...
										<form action="deleteBlog" method="post">
												...
												<input type="text" name="idblog" value='<%=resultSet.getString("idblog")%>' hidden><br>
