...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title>Single Blog Section- Health & Care Medical template</title>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          <span class="text-white">Blog No. <%=idblog%></span>
		...
		<div class="row">
			<div class="col-lg-4 col-md-6">
				<div class="doctor-img-block">
					<img src="resources/images/blog_new/<%=img %>" alt="" class="img-fluid w-100">
