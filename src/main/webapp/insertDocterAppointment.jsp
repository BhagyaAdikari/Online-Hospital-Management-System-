...
<div class="col-lg-8">
           <div class="appoinment-wrap mt-5 mt-lg-0 pl-lg-5">
            ...
            <p class="mb-4">Mollitia dicta commodi est recusandae iste, natus eum asperiores corrupti qui velit . Iste dolorum atque similique praesentium soluta.</p>
               ...
               <form action="AppointmentinsertServlet" method="post">      <!-- form open -->
                    ...
                    <div class="row">
                         <div class="col-lg-6">
                            <div class="form-group">
								...
								<input name="doctername" id="exampleFormControlSelect1" type="text" class="form-control" placeholder="Doctor name">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
								...
								<input name="specilization" id="exampleFormControlSelect2" type="text" class="form-control" placeholder="specilization">
                            </div>
                        </div>
                    ...
                    <div class="form-group-2 mb-4">
                        <textarea name="message" id="message" class="form-control" rows="6" placeholder="Your Message"></textarea>
                         ...
                         <input type="submit" name="submit" value="Make Appointment"  class="btn btn-main btn-round-full" > <br>
