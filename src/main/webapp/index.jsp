...
<head>
  ...
  <title>Novena- Health & Care Medical Center</title>
...
<section class="banner">
    ...
    <video autoplay muted loop playsinline class="bg-video">
        <source src="resources/videos/index-v.mp4" type="video/mp4">
            ...
            <div class="col-lg-6 col-md-12 col-xl-7">
                <div class="block">
                    ...
                    <div class="btn-container">
                        <a href="loginSignUp.jsp" target="_blank" class="btn btn-main-2 btn-icon btn-round-full">
			...
			<div class="col-lg-12">
				<div class="feature-block d-lg-flex">
					<div class="feature-item mb-5 mb-lg-0">
						...
						<a href="insertDocterAppointment.jsp" class="btn btn-main btn-round-full">Make a appoinment</a>
					</div>
	...
	<div class="container">
		<div class="row align-items-center">
			<div class="col-lg-4 col-sm-6">
				<div class="about-img">
					<img src="resources/images/about/img-1.jpg" alt="" class="img-fluid">
					<img src="resources/images/about/img-2.jpg" alt="" class="img-fluid mt-4">
				</div>
			</div>
			<div class="col-lg-4 col-sm-6">
				<div class="about-img mt-4 mt-lg-0">
					<img src="resources/images/about/img-3.jpg" alt="" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-4">
				<div class="about-content pl-4 mt-4 mt-lg-0">
					...
					<a href="userBlog.jsp" class="btn btn-main-2 btn-round-full btn-icon">Read our blogs<i class="icofont-simple-right ml-3"></i></a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row align-items-center">
			<div class="col-lg-6 ">
				<div class="appoinment-content">
					<img src="resources/images/about/img-3.jpg" alt="" class="img-fluid">
					<div class="emergency">
						<h2 class="text-lg"><i class="icofont-phone-circle text-lg"></i>+94 37 2222261</h2>
					</div>
				</div>
			</div>
