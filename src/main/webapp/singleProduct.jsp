...
<body>
	...
	<form action="PharDelete" method="post">
		<h3>
			...
			CustomerID : <input type="text" name="idt1" value="<%=idt1%>"><br>
			<br> Name : <input type="text" name="name" value="<%=name%>"><br>
			<br> Category : <input type="text" name="cate" value="<%=cate%>"><br>
			<br> Price : <input type="text" name="price"	value="<%=price%>"><br>
			<br> Availability : <input type="text" name="avail" value="<%=avail%>"><br> 
			<br>Image : <input type="text" name="img" value="<%=img%>"><br>
			<br> Description : <input type="text" name="des" value="<%=des%>"><br>
			<br> ageRestriction : <input type="text" name="ageRestriction" value="<%=ageRestriction%>"><br> 
			<br>storageConditions : <input type="text" name="storageConditions" value="<%=storageConditions%>"><br>
			<br> usageInstructions : <input type="text" name="usageInstructions" value="<%=usageInstructions%>"><br>
			<br> <input type="submit" name="submit" value="Delete Item">
		</h3>
		<c:url value="pharUpdate.jsp" var="cusupdate">
			<c:param name="idt1" value="<%=idt1%>" />
			<c:param name="name" value="<%=name%>" />
			<c:param name="cate" value="<%=cate%>" />
			<c:param name="price" value="<%=price%>" />
			<c:param name="avail" value="<%=avail%>" />
			<c:param name="img" value="<%=img%>" />
			<c:param name="des" value="<%=des%>" />
			<c:param name="ageRestriction" value="<%=ageRestriction%>" />
			<c:param name="storageConditions" value="<%=storageConditions%>" />
			<c:param name="usageInstructions" value="<%=usageInstructions%>" />
		</c:url>
		...
		<div class="row">
			<div class="col-lg-4 col-md-6">
				<div class="doctor-img-block">
					<img src="resources/images/pharmacy/<%=img %>" alt="" class="img-fluid w-100">

					<div class="info-block mt-4">
						<h4 class="mb-0"><%=avail%></h4>
						<p>staffID : <%=cate%></p>
