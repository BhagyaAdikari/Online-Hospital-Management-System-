                        ...
                        <table width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><%=resultSet.getString("doctername")%></td>
                                    ...
                                    <td>
                                        <c:url value="updateDocterAppointment.jsp" var="appdelete">
                                            <c:param name="id" value='<%=resultSet.getString("id")%>'/>
                                            <c:param name="doctername" value='<%=resultSet.getString("doctername")%>'/>
                                            <c:param name="specilization" value='<%=resultSet.getString("specilization")%>'/>
                                            ...
                                            <c:param name="time" value='<%=resultSet.getString("time")%>'/>
                                        ...
                                        <a href="DeleteAppointmentServlet?id=<%= resultSet.getString("id") %>">
                                            <input type="button" name="update" value="Delete" class="btn" onclick="return confirmDelete()"> 
                                        </a>
                                    </td>
                                </tr>
                                <%
